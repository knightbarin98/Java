...
public class Main {
	...
	public static void main(String[] args) {
		...
		Basket timsBasket = new Basket("Ivan");
...
//		System.out.println(stockList);
		...
		removeItem(timsBasket,"car",1);
		System.out.println("cars removed: " + removeItem(timsBasket,"car",1)); //should return 0
		
		System.out.println(timsBasket);
		
		//remove all items tim basket
		...
		//Collection could not be modified but the elements yes
...
//		}
	...
	public static int sellItem(Basket basket, String item, int quantity) {
		...
		if(stockItem == null) {
			System.out.println("We dont sell item " + item);
			return 0;
		}
